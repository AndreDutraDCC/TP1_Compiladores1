...
public class Generator {
    ...
    public Generator() {
        ...
        varMapping_ = new ArrayList<String>();
        parMapping_ = new ArrayList<String>();
    ...
    public int temporaryFromVariable(String varName) {
        ...
        varMapping_.add(String.format("Variavel \"%s\" esta associada a \"%s\"", varName, "t" + associatedId));
        return associatedId;
    }

    public int temporaryFromParam(String parName) {
        int associatedId = getTemporary();
        parMapping_.add(String.format("Parametro \"%s\" esta associado a \"%s\"", parName, "t" + associatedId));
        return associatedId;
    }
    ...
    public String getVariableAssociations() {
        ...
        if(numAssociations <= 0)
            return "";
        String res = "";
        for(int i = 0; i < numAssociations - 1; i++)
            res += varMapping_.get(i) + "\n";
        res += varMapping_.get(numAssociations - 1);
        return res;
    }
    ...
    public String getParameterAssociations() {
        ...
        String res = "";
        for(int i = 0; i < numAssociations - 1; i++)
            res += parMapping_.get(i) + "\n";
        res += parMapping_.get(numAssociations - 1);
        return res;
    }
    ...
    private ArrayList<String> varMapping_;
    private ArrayList<String> parMapping_;
